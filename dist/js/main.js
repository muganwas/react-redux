...
var _registerServiceWorker = __webpack_require__(103);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(13), __webpack_require__(66)(module)))
...
var _reduxPromiseMiddleware = __webpack_require__(78);
...
store.dispatch({
    type: "FETCH_USERS",
    payload: _axios2.default.get("http://rest.learncode.academy/api/muganwas/friends")
});
store.dispatch({
    type: "FETCH_TWEETS",
    payload: {
        tweet1: "Hello",
        tweet2: "Give me a cocokie"
    }
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__isPromise_js__ = __webpack_require__(79);
...
var _tweets = __webpack_require__(100);
